...
The goal of this project is to create a way to reserve meeting rooms in the CS department and show those room reservations on the monitor of the meeting room
...
use `git clone https://github.com/CSUF-ACM/room-reservation-monitor.git` to clone the repository into your folder
...
If you would like to have the code on your branch merged with the master, please submit a pull request on the git hub page https://github.com/CSUF-ACM/room-reservation-monitor/pulls
